  ...
  render(): TemplateResult {
    ...
    return html`
      <ha-settings-row>
        ...
        <ha-switch id="show_percent" @change=${this._onShowPercentChange} .checked=${this.getBoolConfigVal('show_percent', true)} name="show_percent"></ha-switch>
      </ha-settings-row>
      <ha-settings-row>
        ...
        <ha-switch id="black_as_white" @change=${this._onBlackAsWhiteChange} .checked=${this.getBoolConfigVal('black_as_white', true)} name="black_as_white"></ha-switch>
      </ha-settings-row>
    `;
  }
