...
`;function Fe(e,t,r){const s=e?.[t];return void 0!==s?!!s:r}var Ze="https://github.com/hondzik/printer-toner-level-feature";async function Ge(e,t,r,s){const o=new Date(Date.now()-86400*s*1e3).toISOString(),i=await e.callWS({type:"recorder/statistics_during_period",start_time:o,statistic_ids:[t],period:r,types:["mean"]}),n=i?.[t]??[];for(let e=n.length-1;e>=0;e--){const t=n[e].mean;if("number"==typeof t)return{level:Math.round(t),start:n[e].start}}}const Je=["cyan","magenta","yellow","black"],Ye={cyan:["cyan"],magenta:["magenta"],yellow:["yellow"],black:["black"]};function Qe(e,t){const r=e.entities,s=t?r?.[t]?.device_id:void 0;if(!r||!s)return{};const o=Object.values(r).filter(e=>e.device_id===s&&e.entity_id.startsWith("sensor.")).map(t=>({entityId:t.entity_id,stateObj:e.states[t.entity_id]})).filter(({stateObj:e})=>!!e&&("%"===e.attributes?.unit_of_measurement||("unavailable"===e.state||"unknown"===e.state))).sort((e,t)=>e.entityId.localeCompare(t.entityId)),i={},n=new Set;for(const e of Je){const t=o.find(({entityId:t,stateObj:r})=>{if(n.has(t))return!1;const s=`${r?.attributes?.friendly_name??""} ${t}`.toLowerCase();return Ye[e].some(e=>s.includes(e))});t&&(i[e]=t.entityId,n.add(t.entityId))}return i}function Xe(e,t,r,s){const o=Number(e.states[r]?.state);return{color:t,origin:s,entityId:r,level:Number.isFinite(o)?o:void 0}}const et={cyan:"rgba(0, 255, 255, 0.7)",magenta:"rgba(255, 0, 255, 0.7)",yellow:"rgba(255, 255, 0, 0.7)",black:"var(--primary-text-color)"};let tt=class extends ae{constructor(){super(...arguments),this.config={}}setConfig(e){this.config={...e}}static get styles(){return n`
      .section-label {
    ...
    `}get _autoEntities(){return this.hass?Qe(this.hass,this.context?.entity_id):{}}get _hasAttributeContract(){const e=this.context?.entity_id?this.hass?.states[this.context.entity_id]:void 0;return!!e&&"printer"===e.attributes?.domain&&"number"==typeof e.attributes?.black_level}get _deviceName(){const e=this.hass,t=this.context?.entity_id?e?.entities?.[this.context.entity_id]?.device_id:void 0,r=t?e?.devices?.[t]:void 0;return r?.name_by_user??r?.name}render(){const e=Ve(this.hass),t=this._autoEntities,r=Object.keys(t).length;let s;s=this._hasAttributeContract&&0===r?e("editor.sources.mode_attributes"):e(r>0?"editor.sources.mode_auto":"editor.sources.mode_none");const o=r>0?this._deviceName:void 0;return K`
      ...
      ${Je.map(t=>this.renderSourceRow(t,e))}
      <div class="options">
        <ha-settings-row>
    ...
    `}renderSourceRow(e,t){const r=this.config[`${e}_entity`],s=this._autoEntities[e],o=r??s??"";let i=V;return r?i=K`<span class="chip manual">${t("editor.sources.manual")}</span>`:s&&(i=K`<span class="chip auto">${t("editor.sources.auto")}</span>`),K`
      <div class="source-row">
        <div class="swatch-col">
          <span class="swatch" style="background-color: ${et[e]}"></span>
    ...
    `}_onSourceChange(e,t){t.stopPropagation();const r=t.detail?.value||void 0,s={...this.config};r&&r!==this._autoEntities[e]?s[`${e}_entity`]=r:delete s[`${e}_entity`],this._updateConfig(s)}_onSourceReset(e){const t={...this.config};delete t[`${e}_entity`],this._updateConfig(t)}_onShowPercentChange(e){const t=e.target.checked;this._updateConfig({...this.config,show_percent:t})}_onBlackAsWhiteChange(e){const t=e.target.checked;this._updateConfig({...this.config,black_as_white:t})}_updateConfig(e){this.config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.config},bubbles:!0,composed:!0}))}};e([pe({attribute:!1})],tt.prototype,"hass",void 0),e([pe({attribute:!1})],tt.prototype,"context",void 0),e([pe({type:Object})],tt.prototype,"config",void 0),tt=e([ce("printer-toner-level-feature-config")],tt),function(){const e="padding: 2px 4px; font-family: Roboto,Verdana,Geneva,sans-serif;",t=`background-color: rgb(255, 127, 15); color: rgb(0, 0, 49); ${e}`,r=`background-color: rgb(0, 0, 49); color: rgb(255, 127, 15); ${e}`;console.groupCollapsed("%cPrinter toner Tile card feature%c1.0.7",t,r),console.info("A Home Assistant Lovelace custom card feature to display printer toner levels"),console.info(`Github: ${Ze}`),console.groupEnd()}();let rt=class extends ae{constructor(){super(...arguments),this._lastKnown={},this._lastKnownFetching=new Set}static getConfigElement(){return document.createElement("printer-toner-level-feature-config")}static getStubConfig(){return{type:"custom:printer-toner-level-feature"}}get stateObj(){return this.context?.entity_id?this.hass?.states[this.context.entity_id]:void 0}set stateObj(e){}get tonerSources(){return this.hass?function(e,t,r){const s=t?e.states[t]:void 0,o=Qe(e,t),i={};for(const t of Je){const n=r?.[`${t}_entity`];if(n){i[t]=Xe(e,t,n,"manual");continue}const a=s?.attributes?.[t+"_level"];if("number"==typeof a){i[t]={color:t,origin:"attribute",level:a};continue}const l=o[t];l&&(i[t]=Xe(e,t,l,"auto"))}return i}(this.hass,this.context?.entity_id,this.config):{}}get isColorPrinter(){return!!this.tonerSources.cyan}getCardSize(){return this.isColorPrinter?3:2}setConfig(e){this.config=e}render(){const e=this.hass&&this.config&&this.context?this.tonerSources:{};if(!e.black)return K`
        <div class="toners">
    ...
    `}_queueLastKnown(e){if(!this.hass||this._lastKnownFetching.has(e))return;const t=this._lastKnown[e];t&&Date.now()-t.fetchedAt<18e5||(this._lastKnownFetching.add(e),async function(e,t){return await Ge(e,t,"hour",365)??await Ge(e,t,"5minute",10)}(this.hass,e).then(t=>{this._lastKnown={...this._lastKnown,[e]:{value:t,fetchedAt:Date.now()}}}).catch(()=>{this._lastKnown={...this._lastKnown,[e]:{fetchedAt:Date.now()}}}).finally(()=>{this._lastKnownFetching.delete(e)}))}static get styles(){return qe}};e([pe({attribute:!1})],rt.prototype,"hass",void 0),e([pe({attribute:!1})],rt.prototype,"config",void 0),e([pe({attribute:!1})],rt.prototype,"context",void 0),e([function(e){return pe({...e,state:!0,attribute:!1})}()],rt.prototype,"_lastKnown",void 0),rt=e([ce("printer-toner-level-feature")],rt),window.customCardFeatures||=[],window.customCardFeatures.push({type:"printer-toner-level-feature",name:"Printer toner level",isSupported:(e,t)=>{const r=t.entity_id?e.states[t.entity_id]:void 0;return!(!r||"printer"!==r.attributes?.domain||"number"!=typeof r.attributes?.black_level)||!!Qe(e,t.entity_id).black},configurable:!0});export{rt as PrinterTonerLevelFeature};
